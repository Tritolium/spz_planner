                ...
                .map((att) => {
                    ...
                    return(
                        <tr key={att.Location + att.Event_ID}>
                            ...
                            <TableData><Terminzusage event={att} states={states} attendence={att.Attendence} onClick={onClick} event_id={att.Event_ID} cancelled={att.Type.includes('Abgesagt')}/></TableData>
                        </tr>
                    )
                })}
            </tbody>
